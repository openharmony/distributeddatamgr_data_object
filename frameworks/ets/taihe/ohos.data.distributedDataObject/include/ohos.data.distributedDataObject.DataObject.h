...
public:
    ...
    void SetSessionIdPromiseSync(::taihe::optional_view<::taihe::string> sessionId);
    ...
    void OnChange(::taihe::callback_view<void(::taihe::string_view, ::taihe::array_view<::taihe::string>)> callback);
    void OffChange(
    ...
    void OffStatus(
        ::taihe::optional_view<::taihe::callback<void(::taihe::string_view, ::taihe::string_view,
            ::taihe::string_view)>>callback);
    void OnProgressChanged(::taihe::callback_view<void(::taihe::string_view, int32_t)> callback);
    void OffProgressChanged(::taihe::optional_view<::taihe::callback<void(::taihe::string_view, int32_t)>> callback);
    void BindAssetStoreSync(
        ::taihe::string_view assetKey, ::ohos::data::distributedDataObject::BindInfo const &bindInfo);

    ::ohos::data::distributedDataObject::ObjectValueType HandleGetSessionId(ani_env* aniEnv, ::taihe::string_view key);
    ::ohos::data::distributedDataObject::ObjectValueType HandleGetVersion(ani_env* aniEnv, ::taihe::string_view key);

    ::ohos::data::distributedDataObject::ObjectValueType GetValueImpl(::taihe::string_view key);
    void SetValueImpl(::taihe::string_view key, ::ohos::data::distributedDataObject::TempAnyType const &paraValue);
    ...
    void UpdateAssetAttribute(OHOS::CommonType::AssetValue &asset, std::string const &externalKey,
