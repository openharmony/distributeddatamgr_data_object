...
#ifndef COLLABORATION_EDIT_LOG_PRINT_H
#define COLLABORATION_EDIT_LOG_PRINT_H
...
{
    return { LOG_CORE, 0xD001652, "CollaborationEditObject" };
}
} // namespace OHOS::CollaborationEdit
...
#endif // COLLABORATION_EDIT_LOG_PRINT_H
