...
extern "C" {
    ...
    /**
    * @Description:The memset_s function copies the value of c (converted to an unsigned char) into each of the first count characters of the objectStore_ pointed to by dest.
    ...
    */
    ...
    /**
    * @Description:The wmemcpy_s function copies n successive wide characters from the objectStore_ pointed to by src into the objectStore_ pointed to by dest.
    * @param dest - destination  address
    * @param destMax -The maximum length of destination buffer
...
#endif
    /**
    * @Description:The memmove_s function copies n characters from the objectStore_ pointed to by src into the objectStore_ pointed to by dest.
    * @param dest - destination  address
    * @param destMax -The maximum length of destination buffer
    * @param src -source  address
    * @param count -copies count wide characters from the  src
...
#if SECUREC_IN_KERNEL == 0
   /**
    * @Description:The wmemmove_s function copies n successive wide characters from the objectStore_ pointed to by src into the objectStore_ pointed to by dest.
    * @param dest - destination  address
    * @param destMax -The maximum length of destination buffer
    * @param src -source  address
    * @param count -copies count wide characters from the  src
    ...
    */
    ...
    /**
    * @Description:The memcpy_s function copies n characters from the objectStore_ pointed to by src into the objectStore_ pointed to by dest.
    * @param dest - destination  address
    * @param destMax -The maximum length of destination buffer
    * @param src -source  address
