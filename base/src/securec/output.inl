...
#ifdef SECUREC_FOR_WCHAR
int SecOutputSW(SecPrintfStream *stream, const wchar_t *cformat, va_list arglist)
#else
int SecOutputS(SecPrintfStream *stream, const char *cformat, va_list arglist)
#endif
{
            ...
            case SECUREC_CHAR('a'):
                {
...

                    {
                        ...
                        while (SECUREC_CHAR('%') != *pFltFmt) { /* must meet '%' */
                            --pFltFmt;
                        }
